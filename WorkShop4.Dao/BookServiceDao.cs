...
{
    public class BookServiceDao : IBookServiceDao
    {
        //取得連線字串
        ...
        /// <returns></returns>
        public List<BookLendRecord> GetBookLendRecord(WorkShop4.Model.BookLendRecord booklendrecord)
        {
            //宣告datatable物件
        ...
        /// <returns></returns>
        public int InsertBook(WorkShop4.Model.InsertBookData insertbookdata)
        {
        ...
        {
            List<UpdateBookData> result = new List<UpdateBookData>();
            DataTable dt = new DataTable();
        ...
        {
            List<LendRecord> result = new List<LendRecord>();
            DataTable dt = new DataTable();
